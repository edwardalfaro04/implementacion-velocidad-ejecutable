...
public class Discrete_Particle {
    ...
    public void copyPosition(List<Allocation> positionCopy) {
     ...
     /** Copy position[] to positionCopy[] */
    public void copyVelocity(List<Allocation> velocityCopy) {
        velocityCopy.clear();
        for(Allocation alloc : velocity)
            velocityCopy.add(new Allocation(alloc.getContainer(), alloc.getVm(), alloc.getHost()));
    }
